...
import jieba
from transformers import PreTrainedTokenizer, BertTokenizer, T5Tokenizer as OldT5Tokenizer, AutoTokenizer
...
class PegasusTokenizer(PreTrainedTokenizer):
    ...
    def build_inputs_with_special_tokens(
        ...
        return [self.pad_token_id] + token_ids_0 + [self.eos_token_id]
...
class T5Tokenizer(OldT5Tokenizer):
